...
This project uses [mise](https://mise.jdx.dev/) to manage pinned tool versions (Node, Bun) and [Bun](https://bun.sh/) as the package manager.

```bash
git clone https://github.com/pleaseai/asana.git
cd asana
mise trust && mise install   # install pinned tool versions (Node, Bun)
